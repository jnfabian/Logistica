...
Public Class RptEstadoEdicion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clases.RptEstadoEdicion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptEstadoEdicion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptEstadoEdicion = New RptEstadoEdicion()
        rpt.Site = Me.Site
        Return rpt
    End Function
