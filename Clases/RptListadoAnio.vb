...
Public Class RptListadoAnio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clases.RptListadoAnio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptListadoAnio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptListadoAnio = New RptListadoAnio()
        rpt.Site = Me.Site
        Return rpt
    End Function
