...
Public Class RptEstadoPagina
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clases.RptEstadoPagina.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptEstadoPagina
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptEstadoPagina = New RptEstadoPagina()
        rpt.Site = Me.Site
        Return rpt
    End Function
